...
window.PRODUCTS = [
  ...
  { id: 't07', name: 'Nike Sportswear Club Tee', category: 'tees', subcategory: 'short-sleeve', rank: 102, price: 30, sizes: ['S','M','L','XL','XXL'], stock: { S: 6, M: 12, L: 10, XL: 6, XXL: 3 }, palette: ['#0a0a0a','#1a1a1a','#cc0033'], glyph: 'NSW', drop: 'SS26', materials: 'Coton · logo swoosh brodé poitrine', cut: 'Standard', made: 'Vietnam', image: 'uploads/batch28/nike-tee/c01.jpg?v=2' },
  ...
  { id: 'h07', name: 'Pull tricot LV Comics', category: 'hoodies', subcategory: 'crewnecks', rank: 105, price: 95, sizes: ['S','M','L','XL'], stock: { S: 2, M: 4, L: 4, XL: 2 }, palette: ['#f0e8dc','#a08070','#3a2a1a'], glyph: 'LV', drop: 'SS26', materials: 'Coton brossé · imprimé LV Comics all-over', cut: 'Regular', made: 'China', image: 'uploads/batch28/lv-knit/c01.jpg?v=2' },
  ...
  { id: 'sh05', name: 'Short de foot vintage', category: 'shorts', subcategory: 'sport', rank: 116, price: 25, sizes: ['S','M','L','XL'], stock: { S: 4, M: 8, L: 7, XL: 3 }, palette: ['#0a3a78','#cc0033','#f4f1ea'], glyph: 'FUT', drop: 'SS26', materials: 'Polyester recyclé · réplique pro', cut: 'Standard', made: 'Thailand', image: 'uploads/batch28/short-foot/c01.jpg?v=2' },
